...
module.exports = {
	...
	callback: async (client, interaction, globals) => {
		...
		embed.addField(`:tank: Tanks 0/${partyComp.tanks}`, '-', true)
		embed.addField(`:healer: Healers 0/${partyComp.healers}`, '-', true)
		embed.addField(`:melee: Damage 0/${partyComp.dps}`, '-', true)
