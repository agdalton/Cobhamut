	...
	const embed = new MessageEmbed()
		...
		.addField(
			...
			'**```Description```**```Type in a brief description of your party.\n\n```**Party Size**\nLeave this field alone. It should be automatically filled in with the number of players you chose earlier.\n\n' +
				...
				"**Ping role**\nIf you selected a role to ping when submitting the initial command, it's snowflake value will appear here. **Do not change this field.**</pre>```"
		)
		.addField(
